...
```{r}
divvy_data <- read.csv('Divy_daily_duration.csv')
...
## Part 6: Regression with ARIMA error (with Temp)
...
## Part 7: Vector AutoRegression (VAR)
...
## Part 10: Neural Network Autoregression
